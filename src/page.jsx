                ...
                <div className="body">
                    <div className="bg-gray-2">
                        <div className="row mx-0">
                            <div className="col-md-6 col-lg-8 p-md-5 p-2">
                                ...
                                <Accordion defaultActiveKey="0">
                                    ...
                                    <Accordion.Toggle eventKey="2" as = { Button } variant="link" className ='collapse-accordion-button' >
                                        <span><FontAwesomeIcon icon = { faCircle } /></span> Construcción & Remodelación
                                    </Accordion.Toggle>
                            ...
                            <div className="col-md-6 col-lg-4 p-md-5 p-2">
                                <img className = 'img-fluid' src = { Planos }  alt  = 'Planos' />
                            </div>
                        </div>
                    </div>
                </div>
